...
const About = () => {
    ...
    return(
        ...
        <span className="about-span"> The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.</span>
         <div className="btn">
